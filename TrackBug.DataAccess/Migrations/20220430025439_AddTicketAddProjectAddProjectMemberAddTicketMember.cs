...
{
    public partial class AddTicketAddProjectAddProjectMemberAddTicketMember : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumOfTickets = table.Column<int>(type: "INTEGER", nullable: false),
                    NumOfClosedTickets = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TicketMembers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketMembers_ApplicationUserId",
                table: "TicketMembers",
                column: "ApplicationUserId");
